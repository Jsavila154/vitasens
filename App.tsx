        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              <a href="#" className={`text-2xl font-bold tracking-tighter ${isScrolled ? 'text-vitasens-primary' : 'text-gray-800'}`}>
                VitaSens
              </a>
            </div>
            ...
            <div className="hidden md:flex space-x-8">
              {NAV_ITEMS.map((item) => (
                ...
                >
                    <a 
                      href={item.href}
                      className={`flex items-center text-sm font-medium hover:text-vitasens-primary transition-colors py-2 ${
                    ...
                    {item.submenu && (
                        <div 
                            className={`absolute top-full left-1/2 -translate-x-1/2 pt-4 w-72 transition-all duration-200 ${
